...
class YandexGPT:
    def generate_text(self, prompt):
        system_prompt = (
            ...
            '{"soft_skills": [{"name": "Название навыка", "description": "Описание навыка", "how_to_learn": "Краткое описание как освоить", "demand": "Процент спроса на рынке (только число)"}], "hard_skills": [{"name": "Название навыка", "description": "Описание навыка", "how_to_learn": "Краткое описание как освоить", "demand": "Процент спроса на рынке (только число)"}]}'
        )
